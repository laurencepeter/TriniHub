...
create table if not exists public.notifications (
    ...
    recipient_corporation_id uuid references public.corporations(id) on delete cascade,
    title text not null,
    body text,
...
create index if not exists notifications_corporation_idx on public.notifications (recipient_corporation_id, created_at desc);
...
drop policy if exists civsnap_corp_read on public.civsnap_reports;
create policy civsnap_corp_read on public.civsnap_reports
    for select using (
