...
const List<ServiceOption> externalServiceOptions = [
  ...
  ServiceOption(
    ...
    category: 'External Services',
    heroTitle: 'Report issues in real time',
    heroSubtitle: 'Log a concern and keep tabs on resolution progress.',
    highlights: ['Priority routing', 'Location tagging', 'Status notifications'],
    quickActions: ['New report', 'Attach photo', 'View open cases'],
    formFields: ['Issue summary', 'Location', 'Preferred contact'],
    checkpoints: ['Received', 'Assigned', 'In progress', 'Resolved'],
  ...
  ServiceOption(
    ...
    category: 'External Services',
    heroTitle: 'Flag external software bugs',
...
const List<ServiceOption> internalServiceOptions = [
  ...
  ServiceOption(
    ...
    icon: Icons.report_gmailerrorred,
    category: 'Internal Services',
    heroTitle: 'Log internal issues quickly',
    heroSubtitle: 'Route concerns to the right team with context.',
    highlights: ['Priority routing', 'SLA tracking', 'Private comments'],
    quickActions: ['New issue', 'Assign owner', 'View queue'],
    formFields: ['Issue summary', 'Team impacted', 'Urgency'],
    checkpoints: ['Received', 'Assigned', 'In progress', 'Closed'],
  ...
  ServiceOption(
    ...
    icon: Icons.bug_report,
    category: 'Internal Services',
    heroTitle: 'Track internal software bugs',
