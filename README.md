...
## Server Setup 
:exclamation:Due to lack of accessibile resourcess and time constraints at the Organization I could no longer wait to implement a real life service:exclamation:
